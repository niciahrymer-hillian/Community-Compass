# CLAUDE.md
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#claudemd)
Behavioral guidelines to reduce common LLM coding mistakes. Merge with project-specific instructions as needed.

**Tradeoff:** These guidelines bias toward caution over speed. For trivial tasks, use judgment.

## 1. Think Before Coding
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#1-think-before-coding)
...
## 2. Simplicity First
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#2-simplicity-first)
...
## 3. Surgical Changes
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#3-surgical-changes)
...
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#4-goal-driven-execution)
...
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#5-act-as-a-partner-not-a-tool)
...
- Treat this as a collaborative partnership where we iterate.

## 6. Act as a Teacher
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#6-act-as-a-teacher)
...
- Keep annotated references in sync immediately whenever production code changes, and use the `references/` folder consistently so it remains a reliable long-term learning resource.
...
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#7-reference-documentation-governance)
...
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#8-testing-code-is-essential)
**Write reliable tests. Test often, test early.**

Testing is how we ensure software works as intended and catches regressions.

### Structure and Scope
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#structure-and-scope)
...
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#testing-scenarios-what-to-test)
...
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#test-quality-and-maintenance)
...
### Workflow
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#workflow)
...
### File Organization
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#file-organization)

- Place all tests in the `tests/` folder with clear labels.
- Name test files following the pattern: `test_<module>.js` or `test_<module>.py`.
- Create corresponding subdirectories: `tests/unit/`, `tests/integration/` as needed.
- Use `__init__.py` in Python test folders to make them packages.

### What Not to Test (Unit Testing)
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#what-not-to-test-unit-testing)
...
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#9-github-issue-and-sub-issue-management)
**Keep the backlog clean. Promote checklist items to real sub-issues.**

### Duplicate Detection and Cleanup
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#duplicate-detection-and-cleanup)
...
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#converting-checklist-items-to-real-sub-issues)
...
### Best Practices
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#best-practices)
...
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#10-kanban-card-and-github-project-automation-prompts)
When managing project tasks, always clarify user intent before acting:

### Kanban Card Conversion Flow
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#kanban-card-conversion-flow)
...
2. If no: Do not create cards; ask if the user wants a summary or export instead.
3. **Prompt:** "Would you like me to upload these cards directly to your GitHub repo?"
   If yes: Ask for the GitHub repository URL (e.g., `https://github.com/owner/repo`).
4. If no: Offer to export the cards as markdown, CSV, or another format.
5. **Prompt:** If the site is blocked by sign-in (e.g., GitHub login required): Explain the authentication barrier to the user.
6. Walk the user through the manual sign-in process: Instruct them to open the site in their browser and sign in.
7. After sign-in, return to the automation flow.
8. If automation is not possible, offer a manual step-by-step guide for creating cards/issues.

### Reference for Future Automation
[](https://github.com/niciahrymer-hillian/CircusCircus/blob/main/CLAUDE.md#reference-for-future-automation)
...
## 11. Commit & Push Rule
**After each feature is completed, commit and push the change before moving to the next feature.**

- Each feature should have its own commit.
- Commits must be descriptive and reference the issue when one exists.
- Push completed work to the remote repository immediately so the team can review and iterate.
